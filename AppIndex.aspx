...
<head runat="server">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Instrument+Sans:ital,wght@0,400..700;1,400..700&family=Montserrat:ital,wght@0,100..900;1,100..900&family=Inter:wght@400;600;700&family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Nunito:wght@400;600;700;800&display=swap"
        rel="stylesheet">

    <!-- App header + drawer -->
    <link href="assets/css/AppIndex.css?v=2" rel="stylesheet" />
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="apx-drawer" id="apxDrawer">
    ...
    <section class="hero-section">
        <div class="hero-slider">
            <div class="hero-track">
                ...
                <div class="hero-slide active" style="background-image: url('assets/wow_page_images/hero_slide1.png');">
    ...
    <%--<section class="section2 wow-section">
        <div class="wow-header">
            ...
            <h2 class="wow-heading">Five Reasons it's worth <span class="italic-serif">every rupee</span>
            </h2>
        </div>
        ...
        <div class="wow-container">
            <div class="wow-accordion">
                ...
                <div class="wow-item" data-target="movies">Movie Tickets</div>
                <div class="or"><i>OR</i></div>
                <div class="wow-item active" data-target="insurance">Accidental Insurance</div>
            ...
            <div class="wow-content">
                    ...
                    <div class="revamped-panel theme-yellow">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">From Manali to Mysore. Jaipur to Puri<br>
                                        Your escape is
                                        already paid
                                        for.</span>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="document.getElementById('holiday-section').scrollIntoView({behavior: 'smooth'})">
                                    Click
                                    to
                            ...
                            <div class="asset-card">
                                <img src="assets/wow_page_images/beach_retreat.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images/hill_side.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images/cultural_cities.png">
                            </div>
                        </div>
                        <button class="explore-btn mobile-only-btn" onclick="document.getElementById('holiday-section').scrollIntoView({behavior: 'smooth'})">
                            Click
                            to Explore
                ...
                <div class="content-panel" id="movies">
                    <div class="revamped-panel theme-movies">
                        <div class="mobile-panel-info">
                            <div class="category-icon-wrapper">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 16C0 7.16344 7.16344 0 16 0H40C48.8366 0 56 7.16344 56 16V40C56 48.8366 48.8366 56 40 56H16C7.16344 56 0 48.8366 0 40V16Z" fill="#E6FDFF"></path>
                                    <path d="M17.333 32.0003H19.9997C20.7069 32.0003 21.3852 32.2813 21.8853 32.7814C22.3854 33.2815 22.6663 33.9597 22.6663 34.667V37.3337H23.9997V34.667C23.9997 33.9597 24.2806 33.2815 24.7807 32.7814C25.2808 32.2813 25.9591 32.0003 26.6663 32.0003H29.333C30.0403 32.0003 30.7185 32.2813 31.2186 32.7814C31.7187 33.2815 31.9997 33.9597 31.9997 34.667V37.3337H33.333V34.667C33.333 33.9597 33.614 33.2815 34.1141 32.7814C34.6142 32.2813 35.2924 32.0003 35.9997 32.0003H38.6663C39.3736 32.0003 40.0519 32.2813 40.552 32.7814C41.0521 33.2815 41.333 33.9597 41.333 34.667V37.3337H42.6663V41.3337H13.333V37.3337H14.6663V34.667C14.6663 33.9597 14.9473 33.2815 15.4474 32.7814C15.9475 32.2813 16.6258 32.0003 17.333 32.0003ZM26.6663 21.3337L31.9997 25.3337L26.6663 29.3337V21.3337ZM17.333 14.667H38.6663C39.3736 14.667 40.0519 14.9479 40.552 15.448C41.0521 15.9481 41.333 16.6264 41.333 17.3337V30.0537C40.5253 29.5776 39.6039 29.3289 38.6663 29.3337V17.3337H17.333V29.3337C16.3597 29.3337 15.453 29.587 14.6663 30.0537V17.3337C14.6663 16.6264 14.9473 15.9481 15.4474 15.448C15.9475 14.9479 16.6258 14.667 17.333 14.667Z" fill="#003237"></path>
                                </svg>
                            </div>
                            <div class="category-text">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>Date Night Sorted.<br>
                                    Family Outing Sorted.</h3>
                                <div class="tags">
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="document.getElementById('movies-section').scrollIntoView({behavior: 'smooth'})">
                                    Click
                                    to
                                    Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                            ...
                            <div class="asset-card">
                                <img src="assets/wow_page_images//multiple_screens.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//muliplex_partners.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//nationwide_coverage.png">
                            </div>
                        </div>


                        <button class="explore-btn mobile-only-btn" onclick="document.getElementById('movies-section').scrollIntoView({behavior: 'smooth'})">
                            Click
                            to Explore
                            More <i class="fas fa-chevron-right"></i>
                        </button>
                ...
                <div class="content-panel active" id="insurance">
                    <div class="revamped-panel theme-insurance">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">Peace of mind doesn't have a price tag.<br>
                                        But if it did,
                                        it's already
                                        included.</span>
                        ...
                        <div class="feature-grid">
                            <div class="feature-card">
                                ...
                                <div class="details">
                                    <div class="feature-value">Accident Death coverage </div>
                            ...
                            <div class="feature-card">
                                <i class="fas fa-shield-halved"></i>
                                <div class="details">
                                    <div class="feature-value">Permanent Disability </div>
                            ...
                            <div class="feature-card">
                                <i class="fas fa-shield-halved"></i>
                                <div class="details">
                                    <div class="feature-value">Partially Disability </div>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="window.location.href='https://wow.stanvee.com/insurance.aspx'">
                                    Click to
                                    Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//injury_protection.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//emergency_assistance.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//easy_claim.png">
                            </div>
                        </div>


                        <button class="explore-btn mobile-only-btn" onclick="window.location.href='https://wow.stanvee.com/insurance.aspx'">
                            Click to Explore
                            More <i class="fas fa-chevron-right"></i>
                        </button>
                    </div>
                ...
                <div class="content-panel" id="shopping">
                    <div class="revamped-panel theme-shopping">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">Kitchen appliances. Bluetooth speakers.<br>
                                        Shop smart.
                                        Save big.</span>
                        ...
                        <div class="feature-grid">
                            ...
                            <div class="feature-card">
                                ...
                                <div class="details">
                                    <div class="feature-value">
                                        <a href="https://brandstore.stanveeservices.com/" target="_blank">Use it in Our Brandstore
                                        </a>
                                    </div>
                            ...
                            <div class="feature-card">
                                ...
                                <div class="details">
                                    <div class="feature-value">
                                        <a href="https://shop.stanvee.com/" target="_blank">Use it in our shop
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="document.getElementById('shopping-section').scrollIntoView({behavior: 'smooth'})">
                                    Click
                                    to
                                    Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                            ...
                            <div class="asset-card">
                                <img src="assets/wow_page_images//bluetooth_speakers.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//kitchen_appliances.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//headphones_gadgets.png">
                            </div>
                        </div>


                        <button class="explore-btn mobile-only-btn" onclick="document.getElementById('shopping-section').scrollIntoView({behavior: 'smooth'})">
                            Click
                            to
                ...
                <div class="content-panel" id="scratch">
                    <div class="revamped-panel theme-scratch">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">Scratch the card.<br>
                                        Reveal your Product. It's that
                                        easy.</span>
                        ...
                        <div class="feature-grid">
                            <div class="feature-card">
                                ...
                                <div class="details">
                                    ...
                                    <div class="feature-label">Worth of Products</div>
                                </div>
                            </div>
                            <div class="feature-card">
                                ...
                                <div class="details">
                                    ...
                                    <div class="feature-label">Your Product</div>
                                </div>
                            </div>
                            <div class="feature-card">
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="document.getElementById('scratch-section').scrollIntoView({behavior: 'smooth'})">
                                    Click
                                    to
                                    Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                            ...
                            <div class="asset-card">
                                <img src="assets/wow_page_images//scratch_win.png?v=1.5">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//30_products.png?v=1.5">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//scratch_away.png?v=1.5">
                            </div>
                        </div>


                        <button class="explore-btn mobile-only-btn" onclick="document.getElementById('scratch-section').scrollIntoView({behavior: 'smooth'})">
                            Click
                            to Explore
                            More <i class="fas fa-chevron-right"></i>
                        </button>
                ...
                <div class="content-panel" id="product">
                    <div class="revamped-panel theme-product">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">Choose any one product from our collection.<br>
                                        Yours, on
                                        us.</span>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="document.getElementById('product-section').scrollIntoView({behavior: 'smooth'})">
                                    Click
                                    to
                                    Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                            ...
                            <div class="asset-card">
                                <img src="assets/wow_page_images//our_gift.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//no_money_spent.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//choose_from_selection.png">
                            </div>
                        </div>


                        <button class="explore-btn mobile-only-btn" onclick="document.getElementById('product-section').scrollIntoView({behavior: 'smooth'})">
                            Click
                            to Explore
                            More <i class="fas fa-chevron-right"></i>
                        </button>
        ...
        <div class="wow-pagination hide-desktop">
            <div class="wow-dot active"></div>
            <div class="wow-dot"></div>
            <div class="wow-dot"></div>
            <div class="wow-dot"></div>
            <div class="wow-dot"></div>
            <div class="wow-dot"></div>
            <div class="wow-index">1/6</div>
        </div>
    </section>--%>
            ...
            <div class="wow-content">
                <div class="content-panel" id="stay">
                    <div class="revamped-panel theme-yellow">
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="window.open('https://holiday.stanvee.com/', '_blank')">
                                    Click
                                to
                                Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="window.open('https://holiday.stanvee.com/', '_blank')">
                            Click
                        to Explore
                        More <i class="fas fa-chevron-right"></i>
                        </button>
                ...
                <div class="content-panel" id="movies">
                    <div class="revamped-panel theme-movies">
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="window.open('MovieBookingRedirect.aspx', '_blank')">
                                    Click
                                to
                                Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="window.open('MovieBookingRedirect.aspx', '_blank')">
                            Click
                        to Explore
                        More <i class="fas fa-chevron-right"></i>
                        </button>
                ...
                <div class="content-panel active" id="insurance">
                    <div class="revamped-panel theme-insurance">
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="window.open('insurance.aspx', '_blank')">
                                    Click to
                                Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                            </div>
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="window.open('insurance.aspx', '_blank')">
                            Click to Explore
                        More <i class="fas fa-chevron-right"></i>
                        </button>
                    </div>
                ...
                <div class="content-panel" id="shopping">
                    <div class="revamped-panel theme-shopping">
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="window.open('https://shop.stanvee.com/', '_blank')">
                                    Click
                                to
                                Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="window.open('https://shop.stanvee.com/', '_blank')">
                            Click
                        to
                        Explore More <i class="fas fa-chevron-right"></i>
                        </button>
                ...
                <div class="content-panel" id="scratch">
                    <div class="revamped-panel theme-scratch">
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="window.open('ScratchCard.aspx', '_blank')">
                                    Click
                                to
                                Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                            ...
                            <img src="assets/wow_page_images/scratchcard.png" />
                        </div>
                        <div class="asset-card">

                            <img src="assets/wow_page_images/30+%20products.png" />
                        </div>
                        <div class="asset-card">

                            <img src="assets/wow_page_images/sc.jpeg" />
                        </div>--%>
                            <div class="asset-card">
                                <img src="assets/wow_page_images//scratch_win.png?v=1.5">
                            </div>
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="window.open('ScratchCard.aspx', '_blank')">
                            Click
                        to Explore
                        More <i class="fas fa-chevron-right"></i>
                        </button>
                ...
                <div class="content-panel" id="product">
                    <div class="revamped-panel theme-product">
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn" onclick="window.open('freeProduct.aspx', '_blank')">
                                    Click
                                to
                                Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="window.open('freeProduct.aspx', '_blank')">
                            Click
                        to Explore
                        More <i class="fas fa-chevron-right"></i>
                        </button>
    ...
    <section class="section4 movies-carousel-section" id="movies-section">
        <div class="movies-container">
            ...
            <div class="movie-carousel" id="movieCarousel">
                <button type="button" class="movie-nav-btn prev" id="moviePrev">
                    ...
                    <div class="movie-track" id="movieTrack">
                        <div class="movie-slide" data-index="0">
                            <div class="movie-poster">
                                <img src="assets/movies/ustaad.png" alt="Ustaad">
                            </div>
                        ...
                        <div class="movie-slide" data-index="1">
                            <div class="movie-poster">
                                <img src="assets/movies/biker_poster.png" alt="Biker">
                            </div>
                            <div class="movie-info">
                        ...
                        <div class="movie-slide" data-index="2">
                            <div class="movie-poster">
                                <img src="assets/movies/dhurandar_poster.png" alt="Dhurandar: The Revenge">
                            </div>
                            <div class="movie-info">
                        ...
                        <div class="movie-slide" data-index="3">
                            <div class="movie-poster">
                                <img src="assets/movies/hail_mary_poster.png" alt="Project Hail Mary">
                            </div>
                            <div class="movie-info">
                        ...
                        <div class="movie-slide" data-index="4">
                            <div class="movie-poster">
                                <img src="assets/movies/assi.png" alt="Asur">
                            </div>
                            <div class="movie-info">
                ...
                <button type="button" class="movie-nav-btn next" id="movieNext">
                    <i class="fas fa-chevron-right"></i>
                </button>
            </div>

            <div class="movies-cta">
                <a href="http://movie.stanvee.com/" target="_blank" class="orange-pill-btn">Browse the latest movies <span><i class="fas fa-arrow-right"></i></span>
                </a>
            </div>
        </div>
    </section>
    <%--<section class="section4 movies-carousel-section" id="movies-section">
        <div class="movies-container">
            ...
            <div class="movie-carousel" id="movieCarousel">
                <button type="button" type="button" class="movie-nav-btn prev" id="moviePrev">
                    <i class="fas fa-chevron-left"></i>
                </button>
                            ...
                            <ItemTemplate>
                                <div class="movie-slide" data-index="0">
                                    <div class="movie-poster">
                                        ...
                                        <img src="<%# Eval("ImageUrl") %>" alt="Ustaad">
                                    </div>
                                    <div class="movie-info">
                                        <h3 class="movie-title"><%# Eval("MovieName") %></h3>
                                        <div class="movie-meta-row">
                                            <span class="movie-badge">U/A 13+</span>
                                            <span class="movie-meta">Telugu, Tamil</span>
                                        </div>
                ...
                <button type="button" type="button" class="movie-nav-btn next" id="movieNext">
                    <i class="fas fa-chevron-right"></i>
                </button>
            </div>
    ...
    <section class="section5 shop-points-section" id="shopping-section">
        <div class="shop-points-container">
            ...
            <div class="shop-carousel-container">
                <button type="button" class="shop-nav-btn prev" id="shopPrev">
                    <i class="fas fa-chevron-left"></i>
                </button>
                    ...
                    <div class="shop-track" id="shopTrack">
                        ...
                        <div class="shop-slide" data-index="0">
                            <div class="shop-card">
                                <div class="shop-card-image">
                                    <img src="assets/wow_page_images/bt_speakers.png" alt="Bluetooth Speaker">
                                </div>
                        ...
                        <div class="shop-slide" data-index="1">
                            <div class="shop-card">
                                ...
                                <div class="shop-card-image">
                                    <img src="assets/wow_page_images/lock_master.png" alt="Lock Master">
                                </div>
                                <div class="shop-card-info">
                        ...
                        <div class="shop-slide" data-index="2">
                            <div class="shop-card">
                                <div class="shop-card-image">
                                    <img src="assets/wow_page_images/mixer_juicer.png" alt="Multi-Utility Mixer and Juicer">
                                </div>
                                <div class="shop-card-info">
                        ...
                        <div class="shop-slide" data-index="3">
                            <div class="shop-card">
                                <div class="shop-card-image">
                                    <img src="assets/wow_page_images/toaster.png" alt="Toasty Delight Sandwich Maker">
                                </div>
                                <div class="shop-card-info">
                        ...
                        <div class="shop-slide" data-index="4">
                            <div class="shop-card">
                                <div class="shop-card-image">
                                    <img src="assets/wow_page_images/bath_towel_set.png" alt="Bath Towel Set">
                                </div>
                                <div class="shop-card-info">
                ...
                <button type="button" class="shop-nav-btn next" id="shopNext">
                    <i class="fas fa-chevron-right"></i>
                </button>
            </div>

            <div class="shop-cta">
                <a href="https://shop.stanvee.com/" target="_blank" class="white-pill-btn">Start Shopping Now! <span><i class="fas fa-arrow-right"></i></span>
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="section6 scratch-card-section" id="scratch-section">
        <div class="scratch-card-container">
            ...
            <div class="scratch-carousel-container">
                <button type="button" type="button" class="scratch-nav-btn prev" id="scratchPrev">
                    <i class="fas fa-chevron-left"></i>
                </button>
                                ...
                                <div class="scratch-slide" data-index="0">
                                    <div class="scratch-card">
                                        <div class="scratch-card-image">
                                            <img src="<%# Eval("ImageUrl") %>" alt="Kitchen Queen Knife">
                                            <%-- <img src="assets/wow_page_images/knife_set.png" alt="Kitchen Queen Knife">--%>
                                        </div>
                                    </div>
                ...
                <button type="button" type="button" class="scratch-nav-btn next" id="scratchNext">
                    <i class="fas fa-chevron-right"></i>
                </button>
            </div>

            <div class="scratch-cta">
                <a href="https://wow.stanvee.com/ScratchCard.aspx" target="_blank" class="orange-pill-cta">Try Your Luck <span><i class="fas fa-arrow-right"></i></span>
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="section7 free-product-section" id="product-section">
        <div class="free-product-container">
            ...
            <div class="free-product-carousel-container">
                <button type="button" type="button" class="free-product-nav-btn prev" id="freeProductPrev">
                    <i class="fas fa-chevron-left"></i>
                </button>
                        ...
                        <ItemTemplate>
                            <div class="free-product-card">
                                <div class="free-product-image">
                                    <img src="<%# Eval("ImageUrl") %>" alt="Bluetooth Speaker">
                                    <%--      <img src="assets/wow_page_images/swift_sling_bag.png" alt="Swift Sling Bag">--%>
                                </div>
                ...
                <button type="button" type="button" class="free-product-nav-btn next" id="freeProductNext">
                    <i class="fas fa-chevron-right"></i>
                </button>
            </div>
        </div>
        ...
        <div class="free-product-cta">
            <a href="https://wow.stanvee.com/freeProduct.aspx" target="_blank" class="white-pill-btn">Claim Your Free Poduct <span><i class="fas fa-arrow-right"></i></span>
            </a>
        </div>
        </div>
    </section>
    ...
    <section class="section8 destinations" id="holiday-section">
        <div class="destinations-container">
            ...
            <h2 class="destinations-heading">Where will your WOW Card <span>take you?</span>
            </h2>
            <p class="description">
            ...
            <div class="destinations-scroller">
                <div class="destinations-grid">
                    <div class="destinations-card manali-card">
                        ...
                        <img src="assets/wow_page_images/manali_new.jpg" alt="Manali">
                        <div class="destinations-overlay">
                            <h3>Manali</h3>
                            <p>Snowy peaks, pine forests</p>
                            <a href="HolidayRedirect.aspx">BOOK NOW <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>

                    <div class="destinations-card ooty-card">
                        <span class="state-tag">Tamil Nadu</span>
                        <img src="assets/wow_page_images/ooty_new.jpg" alt="Ooty">
                        <div class="destinations-overlay">
                            <h3>Ooty</h3>
                            <p>Tea Gardens</p>
                            <a href="HolidayRedirect.aspx">BOOK NOW <i class="fas fa-arrow-right"></i></a>
                    ...
                    <div class="destinations-card puri-card">
                        ...
                        <img src="assets/wow_page_images/puri_new.jpg" alt="Puri">
                        <div class="destinations-overlay">
                            <h3>Puri</h3>
                    ...
                    <div class="destinations-card amritsar-card">
                        ...
                        <img src="assets/wow_page_images/amritsar_new.jpg" alt="Amritsar">
                        <div class="destinations-overlay">
                            <h3>Amritsar</h3>
                            <p>Golden Temple</p>
                            <a href="HolidayRedirect.aspx">BOOK NOW <i class="fas fa-arrow-right"></i></a>
                ...
                <div class="destinations-slider">
                    <div class="destinations-card agra-card">
                        ...
                        <img src="assets/wow_page_images/agra_new.jpg" alt="Agra">
                        <div class="destinations-overlay">
                            <h3>Agra</h3>
                            <p>Taj Mahal</p>
                            <a href="HolidayRedirect.aspx">BOOK NOW <i class="fas fa-arrow-right"></i></a>
                    ...
                    <div class="destinations-card mysore-card">
                        ...
                        <img src="assets/wow_page_images/mysore_new.jpg" alt="Mysore">
                        <div class="destinations-overlay">
                            <h3>Mysore</h3>
                            <p>Royal Palaces</p>
                            <a href="HolidayRedirect.aspx">BOOK NOW <i class="fas fa-arrow-right"></i></a>
                    ...
                    <div class="destinations-card jaipur-card">
                        ...
                        <img src="assets/wow_page_images/jaipur_new.jpg" alt="Jaipur">
                        <div class="destinations-overlay">
                            <h3>Jaipur</h3>
            ...
            <div class="reviews-carousel">
                <div class="reviews-wrapper">
                    <div class="review-card">
                        <p class="review-text">
                            Went with my friend to Manali on the holiday benefit. 3-star hotel, no extra charges.
            For Rs. 999 this is genuinely unbeatable.
                        </p>
                    ...
                    <div class="review-card">
                        <p class="review-text">
                            Won Rs. 4,500 on the scratch card. Redeemed it for Pantaloons + Starbucks. Still
            can't believe it was included in Rs. 999.
                        </p>
                        <div class="review-author">
                    ...
                    <div class="review-card">
                        <p class="review-text">
                            Used the movie tickets for a date night. Shopping coupon covered a Philips earphone
            for my friend. Will 100% renew next year.
                        </p>
                        <div class="review-author">
                    ...
                    <div class="review-card">
                        <p class="review-text">
                            The accidental insurance gave me peace of mind during my trip. Got the free product -
            a nice water bottle. Excellent value!
                        </p>
                        <div class="review-author">
                    ...
                    <div class="review-card">
                        <p class="review-text">
                            Booked a weekend getaway to Mysore. Used the shopping voucher for groceries. This
            membership pays for itself multiple times over.
                        </p>
                        <div class="review-author">
                    ...
                    <div class="review-card">
                        <p class="review-text">
                            Perfect for families! Used the hotel benefit for a trip to Jaipur with kids. No
            hidden costs, everything included. Highly recommend!
                        </p>
                        <div class="review-author">
                ...
                <div class="carousel-navigation">
                    <button type="button" type="button" class="nav-btn prev-btn" id="prevBtn">
                        <i class='fas fa-caret-left'></i>
                    </button>
                    <button type="button" type="button" class="nav-btn next-btn" id="nextBtn">
    ...
    <section class="section10 faq-section">
        <div class="faq-container">
            ...
            <div class="faq-list">
                <div class="faq-item">
                    <button type="button" type="button" class="faq-question">
                    ...
                    <div class="faq-answer">
                        <p>
                            The WOW Card benefits are valid for the period mentioned at the time of purchase. Check the terms for
            specific validity on each benefit.
                        </p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            Yes. 2 Nights / 3 Days at a 3-star or above hotel. Choose from 8+ destinations across India. Plus Rs.
            1,000 food coupon.
                        </p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            After buying the WOW Card, you can purchase a Scratch Card for Rs. 699 and reveal a product worth Rs.
            2,500 to Rs. 15,000.
                        </p>
                    </div>
                </div>
                ...
                <div class="faq-item">
                    ...
                    <div class="faq-answer">
                        <p>
                            Choose one product from our curated selection at no additional cost. Options include a Sling Bag, Thermo
            Steel Bottle, or Collapsible Basket.
                        </p>
                    </div>
                </div>
            ...
            <div class="footer-container">
                <div class="footer-left">
                    ...
                    <div class="social-icons">
                        <a href="https://www.instagram.com/stanvee.india" class="footer-icons">
                            <svg width="20" height="20"
                                viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M14.1665 1.66699H5.83317C3.53198 1.66699 1.6665 3.53247 1.6665 5.83366V14.167C1.6665 16.4682 3.53198 18.3337 5.83317 18.3337H14.1665C16.4677 18.3337 18.3332 16.4682 18.3332 14.167V5.83366C18.3332 3.53247 16.4677 1.66699 14.1665 1.66699Z"
                                    stroke="#EBE0D0" stroke-width="1.45833" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                    ...
                                    stroke="#EBE0D0" stroke-width="1.45833" stroke-linecap="round" stroke-linejoin="round" />
                                <path
                                    d="M14.5002 6.16634C14.8684 6.16634 15.1668 5.86786 15.1668 5.49967C15.1668 5.13148 14.8684 4.83301 14.5002 4.83301C14.132 4.83301 13.8335 5.13148 13.8335 5.49967C13.8335 5.86786 14.132 6.16634 14.5002 6.16634Z"
                                    fill="#EBE0D0" />
                            </svg>

                        </a>
                        <a href="https://www.facebook.com/stanvee.india" class="footer-icons">
                            <svg width="20" height="20"
                                viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M14.9998 1.66699H12.4998C11.6158 1.66699 10.7679 2.01818 10.1428 2.6433C9.51769 3.26842 9.1665 4.11627 9.1665 5.00033V7.50033H6.6665V10.8337H9.1665V17.5003H12.4998V10.8337H14.9998L15.8332 7.50033H12.4998V5.00033C12.4998 4.77931 12.5876 4.56735 12.7439 4.41107C12.9002 4.25479 13.1122 4.16699 13.3332 4.16699H15.8332L14.9998 1.66699Z"
                                    stroke="#EBE0D0" stroke-width="1.45833" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </a>
                        <a href="https://wa.me/919270511515" target="_blank" class="footer-icons">
                            <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">

                                <path
                                    d="M16.0013 3.19922C8.92931 3.19922 3.20117 8.92736 3.20117 15.9993C3.20117 18.4953 3.91917 20.9273 5.26517 23.0073L3.20117 28.7993L9.16917 26.8153C11.1532 27.9993 13.4733 28.7993 16.0013 28.7993C23.0733 28.7993 28.8014 23.0712 28.8014 15.9993C28.8014 8.92736 23.0733 3.19922 16.0013 3.19922Z"
                                    stroke="#25D366" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />

                                <path
                                    d="M11.2012 10.4004C11.6012 9.60039 12.0012 9.60039 12.4012 9.60039C12.7212 9.60039 13.1212 9.60039 13.4412 9.60039C13.7612 9.60039 14.0012 9.68039 14.1612 10.0804C14.4012 10.6404 15.0412 12.1604 15.1212 12.3204C15.2012 12.4804 15.2812 12.7204 15.1212 12.9604C14.9612 13.2004 14.8012 13.3604 14.6412 13.5204C14.4812 13.6804 14.3212 13.8404 14.1612 14.0004C14.0012 14.1604 13.8412 14.3204 14.0012 14.6404C14.1612 14.9604 14.7212 15.8404 15.5212 16.5604C16.5612 17.4404 17.4412 17.7604 17.7612 17.9204C18.0812 18.0804 18.2412 18.0804 18.4012 17.9204C18.5612 17.7604 19.0412 17.2004 19.2012 16.9604C19.3612 16.7204 19.5212 16.7204 19.8412 16.8804C20.1612 17.0404 21.8412 17.8404 22.1612 18.0004C22.4812 18.1604 22.7212 18.2404 22.8012 18.4004C22.8812 18.5604 22.8812 19.3604 22.4812 20.1604C22.0812 20.9604 20.7212 21.6804 20.1612 21.7604C19.6012 21.8404 18.9612 22.0004 16.5612 21.0404C14.1612 20.0804 12.5612 18.2404 11.9212 17.3604C11.2812 16.4804 10.3212 15.0404 10.3212 13.5204C10.3212 12.0004 10.8012 11.2004 11.2012 10.4004Z"
                                    fill="#25D366" />
                            </svg>
                        </a>
                        <a href="https://www.linkedin.com/company/stanvee" class="footer-icons">
                            <svg width="20" height="20"
                                viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_1683_3712)">
                                    <path
                                        d="M5.10549 2.52484C5.10936 3.01882 4.91866 3.49448 4.5746 3.84896C4.23055 4.20344 3.76079 4.40826 3.26692 4.41913C2.77408 4.40123 2.30696 4.19465 1.96211 3.84209C1.61727 3.48954 1.42107 3.01796 1.41406 2.52484C1.43536 2.04428 1.63869 1.58982 1.98279 1.25367C2.32689 0.917533 2.78599 0.724892 3.26692 0.714844C3.74643 0.725084 4.2039 0.918208 4.54569 1.25469C4.88748 1.59116 5.08774 2.04555 5.10549 2.52484ZM1.61263 7.78484C1.61263 6.69627 2.30549 6.86627 3.26692 6.86627C4.22835 6.86627 4.90692 6.69627 4.90692 7.78484V18.3906C4.90692 19.4934 4.21406 19.2677 3.26692 19.2677C2.31978 19.2677 1.61263 19.4934 1.61263 18.3906V7.78484ZM7.76406 7.78627C7.76406 7.1777 7.98978 6.95056 8.34263 6.88056C8.69549 6.81056 9.91406 6.88056 10.3369 6.88056C10.7612 6.88056 10.9312 7.57342 10.9169 8.09627C11.2803 7.60984 11.762 7.2245 12.3164 6.97694C12.8708 6.72938 13.4793 6.62784 14.0841 6.68199C14.678 6.64572 15.2729 6.73479 15.8302 6.94341C16.3874 7.15202 16.8946 7.47552 17.3187 7.89288C17.7428 8.31025 18.0744 8.81216 18.2919 9.36601C18.5094 9.91986 18.608 10.5133 18.5812 11.1077V18.3477C18.5812 19.4506 17.9026 19.2248 16.9398 19.2248C15.9769 19.2248 15.2998 19.4506 15.2998 18.3477V12.692C15.3247 12.4009 15.2867 12.108 15.1883 11.8329C15.0899 11.5579 14.9335 11.3072 14.7297 11.098C14.5259 10.8887 14.2794 10.7258 14.0071 10.6203C13.7347 10.5147 13.4428 10.469 13.1512 10.4863C12.8607 10.4786 12.572 10.5328 12.304 10.6452C12.0361 10.7576 11.7951 10.9257 11.5971 11.1384C11.3991 11.351 11.2485 11.6033 11.1554 11.8785C11.0622 12.1538 11.0287 12.4457 11.0569 12.7348V18.3906C11.0569 19.4934 10.3641 19.2677 9.40263 19.2677C8.4412 19.2677 7.76263 19.4934 7.76263 18.3906L7.76406 7.78627Z"
                                        stroke="#EBE0D0" stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
                                    <clipPath id="clip0_1683_3712">
                ...
                <div class="footer-links">
                    ...
                    <div class="footer-links-col2">
                        ...
                        <ul>
                            ...
                            <li>How It Works</li>
                            <li><a href="https://gv.stanveeservices.com/index.php?mod=faq">FAQs</a></li>
                ...
                <div class="footer-right-col">
                    <div class="footer-subscribe">
                        <h4>STAY UPDATED</h4>
                        <p>Get updates on new rewards</p>
                    ...
                    <div class="footer-contact-details">
                        <div class="footer-address">
                            <i class='fas fa-map-marker-alt'></i>403, Metropolis, Balewadi High Street, Baner, 411045.
                        </div>
                        <div class="footer-email">
                            <i class='fas fa-envelope'></i><a href="mailto:info@stanvee.com">info@stanvee.com</a>
                        </div>
                        <div class="footer-mobile">
                            <i class='fas fa-phone'></i><a href="tel:+919270521515">+91 92705 21515 &nbsp;/&nbsp; </a>
                            <a href="tel:+919270511515">+91 92705 11515</a>
                        </div>
                    </div>
                </div>
            </div>

            <div class="footer-divider hide-desktop"></div>

            <div class="footer-bottom">
                <p>© 2026 Stanvee. All rights reserved.</p>
                <div class="bottom-links">
                    <a href="https://stanvee.com/terms-conditions.asp" target="_blank">Terms & Conditions</a>
                    <a href="https://stanvee.com/privacy-policy.asp" target="_blank">Privacy Policy</a>
                    <a href="https://gv.stanveeservices.com/index.php?mod=refund_cancel" target="_blank">Refund Policy</a>
                </div>
            </div>
        </footer>

        <script src="assets/css/script.js?v=1"></script>
        <script>
            ...
            // App landing: any button / link / clickable card opens AppLogin (or WebApp if already logged in).
            // Page-only controls (sliders, carousels, tabs, FAQ, drawer) keep working normally.
            (function () {
                var target = '<%= (Session["Status"] != null && Session["Status"].ToString() == "OK") ? "WebApp.aspx" : "AppLogin.aspx" %>';
                var clickable = 'a, button, input[type=submit], input[type=button], [onclick], ' +
                                '.movie-slide, .shop-slide, .scratch-slide, .free-product-card, .destinations-card';
                var uiOnly = '[data-ui], .dot, .wow-item, .movie-nav-btn, .shop-nav-btn, .scratch-nav-btn, ' +
                             '.free-product-nav-btn, .nav-btn, .faq-question';

                window.addEventListener('click', function (e) {
                    var el = e.target.closest(clickable);
                    if (!el || el.closest(uiOnly)) return;
                    e.preventDefault();
