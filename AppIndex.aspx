<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="AppIndex.aspx.cs" Inherits="AppIndex" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script>
        // App landing: any action button/link opens AppLogin (or WebApp if already logged in).
        // Sliders, carousels, accordion tabs, FAQ toggles and menu open/close still work normally.
        (function () {
            var target = '<%= (Session["Status"] != null && Session["Status"].ToString() == "OK") ? "WebApp.aspx" : "AppLogin.aspx" %>';
            var uiOnly = '.dot, .wow-item, .wow-dot, .movie-nav-btn, .shop-nav-btn, .scratch-nav-btn, .free-product-nav-btn, ' +
                         '.nav-btn, .faq-question, .menu-toggle, .close-drawer, .drawer-overlay, .drawer-dropbtn, .dropbtn';
