...
<section class="section2 wow-section">
            ...
            <div class="wow-content">
                <div class="content-panel" id="stay">
                    <div class="revamped-panel theme-yellow">
                        <div class="mobile-panel-info">
                            <div class="category-icon-wrapper"><svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">From Manali to Mysore. Jaipur to Puri<br>Your escape is
                                        already paid
                                        for.</span>
                        ...
                        <div class="feature-grid">
                            ...
                            <div class="feature-card">
                                ...
                                <div class="details">
                                    <div class="feature-value">@Rs/- 1999 <br>
                                        at the time of Booking</div>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner"><button class="asset-grid-btn" onclick="document.getElementById('holiday-section').scrollIntoView({behavior: 'smooth'})">Click
                                    to
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="document.getElementById('holiday-section').scrollIntoView({behavior: 'smooth'})">Click
                            to Explore
                ...
                <div class="content-panel" id="movies">
                    <div class="revamped-panel theme-movies">
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner"><button class="asset-grid-btn" onclick="document.getElementById('movies-section').scrollIntoView({behavior: 'smooth'})">Click
                                    to
                                    Explore More <i class="fas fa-arrow-right"></i></button></div>
                            <div class="asset-card">
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="document.getElementById('movies-section').scrollIntoView({behavior: 'smooth'})">Click
                            to Explore
                            More <i class="fas fa-chevron-right"></i></button>
                    </div>
                </div>
                ...
                <div class="content-panel active" id="insurance">
                    <div class="revamped-panel theme-insurance">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">Peace of mind doesn't have a price tag.<br>But if it did,
                                        it's already
                                        included.</span>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner"><button class="asset-grid-btn" onclick="window.location.href='https://wow.stanvee.com/insurance.aspx'">Click to
                                    Explore More <i class="fas fa-arrow-right"></i></button></div>
                            <div class="asset-card">
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="window.location.href='https://wow.stanvee.com/insurance.aspx'">Click to Explore
                            More <i class="fas fa-chevron-right"></i></button>
                    </div>
                </div>
                ...
                <div class="content-panel" id="shopping">
                    <div class="revamped-panel theme-shopping">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">Kitchen appliances. Bluetooth speakers.<br>Shop smart.
                                        Save big.</span>
                        ...
                        <div class="feature-grid">
                            ...
                            <div class="feature-card">
                                ...
                                <div class="details">
                                    <div class="feature-value">
                                        <a href="https://brandstore.stanveeservices.com/" target="_blank">
                                            Use it in Our Brandstore
                                        </a>
                                    </div>
                            ...
                            <div class="feature-card">
                                ...
                                <div class="details">
                                    <div class="feature-value">
                                        <a href="https://shop.stanvee.com/" target="_blank">
                                            Use it in our shop
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner"><button class="asset-grid-btn" onclick="document.getElementById('shopping-section').scrollIntoView({behavior: 'smooth'})">Click
                                    to
                                    Explore More <i class="fas fa-arrow-right"></i></button></div>
                            <div class="asset-card">
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="document.getElementById('shopping-section').scrollIntoView({behavior: 'smooth'})">Click
                            to
                ...
                <div class="content-panel" id="scratch">
                    <div class="revamped-panel theme-scratch">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">Scratch the card.<br>Reveal your prize. It's that
                                        easy.</span>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner"><button class="asset-grid-btn" onclick="document.getElementById('scratch-section').scrollIntoView({behavior: 'smooth'})">Click
                                    to
                                    Explore More <i class="fas fa-arrow-right"></i></button></div>
                            <div class="asset-card">
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="document.getElementById('scratch-section').scrollIntoView({behavior: 'smooth'})">Click
                            to Explore
                            More <i class="fas fa-chevron-right"></i></button>
                    </div>
                </div>
                ...
                <div class="content-panel" id="product">
                    <div class="revamped-panel theme-product">
                        ...
                        <div class="revamped-banner">
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">Choose any one product from our collection.<br>Yours, on
                                        us.</span>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner"><button class="asset-grid-btn" onclick="document.getElementById('product-section').scrollIntoView({behavior: 'smooth'})">Click
                                    to
                                    Explore More <i class="fas fa-arrow-right"></i></button></div>
                            <div class="asset-card">
                        ...
                        <button class="explore-btn mobile-only-btn" onclick="document.getElementById('product-section').scrollIntoView({behavior: 'smooth'})">Click
                            to Explore
                            More <i class="fas fa-chevron-right"></i></button>
                    </div>
                </div>
        ...
        <div class="wow-pagination hide-desktop"><div class="wow-dot active"></div><div class="wow-dot"></div><div class="wow-dot"></div><div class="wow-dot"></div><div class="wow-dot"></div><div class="wow-dot"></div><div class="wow-index">1/6</div></div>
    </section>
