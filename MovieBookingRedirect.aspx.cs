    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Dt.Rows.Count > 0)
            {
               ...
               // string url = "https://movie.stanvee.com/controller.aspx?user_info=" + encryptedUserInfo + "&log_key=8585351C-3A39-4E86-982D-AEDD6928C900";
                string url = "https://movie.stanvee.com/Account/DirectLogin?log_key=8585351C-3A39-4E86-982D-AEDD6928C900&user_info=" + encryptedUserInfo + "";
                Response.Redirect(url);
            }
            else
            {
                Response.Redirect("https://movie.stanvee.com/");
            }
        }
        catch (Exception ex)
        {
