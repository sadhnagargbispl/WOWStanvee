<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="Main.aspx.cs" Inherits="Main" %>
                ...
                <div class="content-panel" id="insurance">
                  ...
                  included.</span>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn"
                                    onclick="window.location.href='https://wow.stanvee.com/insurance.aspx'">
                                    Click to Explore More <i
                ...
                <div class="content-panel" id="shopping">
                    <div class="revamped-panel theme-shopping">
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn"
                                    onclick="document.getElementById('shopping-section').scrollIntoView({behavior: 'smooth'})">
                                    Click to
                Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                            </div>
                ...
                <div class="content-panel" id="scratch">
                    <div class="revamped-panel theme-scratch">
                            ...
                            <div class="banner-content">
                                <h3>
                                    <span class="hide-mobile">Scratch the card.<br>
                                        Reveal your prize. It's that easy.</span>
                        ...
                        <div class="asset-grid">
                            <div class="asset-grid-inner">
                                <button class="asset-grid-btn"
                                    onclick="document.getElementById('scratch-section').scrollIntoView({behavior: 'smooth'})">
                                    Click to
                Explore More <i class="fas fa-arrow-right"></i>
                                </button>
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images/scratch_win.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images/30_products.png">
                            </div>
                            <div class="asset-card">
                                <img src="assets/wow_page_images/scratch_away.png">
                            </div>
                        </div>
                ...
                <div class="movie-track-container">
                    <div class="movie-track" id="movieTrack">
                            ...
                            <ItemTemplate>
                                <div class="movie-slide" data-index="0">
                                    <div class="movie-poster">
                                        <%--<img src="assets/wow_page_images/ustaad.png" alt="Ustaad">--%>
                        ...
                        <%--  <div class="movie-slide" data-index="1">
                            <div class="movie-poster">
                                <img src="assets/wow_page_images/biker_poster.png" alt="Biker">
                            </div>
                            <div class="movie-info">
                        ...
                        <div class="movie-slide" data-index="2">
                            <div class="movie-poster">
                                <img src="assets/wow_page_images/dhurandar_poster.png" alt="Dhurandar: The Revenge">
                            </div>
                            <div class="movie-info">
                        ...
                        <div class="movie-slide" data-index="3">
                            <div class="movie-poster">
                                <img src="assets/wow_page_images/hail_mary_poster.png" alt="Project Hail Mary">
                            </div>
                            <div class="movie-info">
                        ...
                        <div class="movie-slide" data-index="4">
                            <div class="movie-poster">
                                <img src="assets/wow_page_images/assi.png" alt="Asur">
                            </div>
                            <div class="movie-info">
            ...
            <div class="shop-carousel-container">
                ...
                <div class="shop-track-container">
                    <div class="shop-track" id="shopTrack">
                        ...
                        <asp:Repeater ID="RptScratch" runat="server">
                            <ItemTemplate>
    ...
    <section class="section6 scratch-card-section" id="scratch-section">
        <div class="scratch-card-container">
            ...
            <div class="scratch-carousel-container">
                <button type="button" class="scratch-nav-btn prev" id="scratchPrev">
                    <i class="fas fa-chevron-left"></i>
                </button>
                ...
                <div class="scratch-track-container">
                    <div class="scratch-track" id="scratchTrack">
                        ...
                        <%--  <div class="scratch-slide" data-index="1">
                            <div class="scratch-card">
                                <div class="scratch-card-image">
                                    <img src="assets/wow_page_images/air_fryer.png" alt="Air Fryer 4.5 Ltr">
                                </div>
                            </div>
                            <div class="scratch-card-info">
                        ...
                        <div class="scratch-slide" data-index="2">
                            <div class="scratch-card">
                                <div class="scratch-card-image">
                                    <img src="assets/wow_page_images/juicer.png" alt="Juice Mate Pro">
                                </div>
                            </div>
                            <div class="scratch-card-info">
                        ...
                        <div class="scratch-slide" data-index="3">
                            <div class="scratch-card">
                                <div class="scratch-card-image">
                                    <img src="assets/wow_page_images/branded_jeans.png" alt="Branded Jeans">
                                </div>
                            </div>
                            <div class="scratch-card-info">
                        ...
                        <div class="scratch-slide" data-index="4">
                            <div class="scratch-card">
                                <div class="scratch-card-image">
                                    <img src="assets/wow_page_images/luxury_watch.png" alt="Luxury Watch">
                                </div>
                            </div>
                            <div class="scratch-card-info">
                ...
                <button type="button" class="scratch-nav-btn next" id="scratchNext">
                    <i class="fas fa-chevron-right"></i>
                </button>
            </div>
    ...
    <section class="section7 free-product-section" id="product-section">
        <div class="free-product-container">
            ...
            <div class="free-product-carousel-container">
                <button type="button" class="free-product-nav-btn prev" id="freeProductPrev">
                    <i class="fas fa-chevron-left"></i>
                </button>
                ...
                <div class="free-product-grid">
                    ...
                    <%--<div class="free-product-card">
                        <div class="free-product-image">
                            <img src="assets/wow_page_images/sports_guard_thermos.png" alt="Sports Guard Thermos Steel">
                        </div>
                        <div class="free-product-info">
                    ...
                    <div class="free-product-card">
                        <div class="free-product-image">
                            <img src="assets/wow_page_images/flexi_drain_filter_basket.png" alt="Flexi Drain Filter Basket">
                        </div>
                        <div class="free-product-info">
                    ...
                    <div class="free-product-card">
                        <div class="free-product-image">
                            <img src="assets/wow_page_images/neck_pillow.png" alt="Neck Mate Travel Neck Pillow">
                        </div>
                        <div class="free-product-info">
                ...
                <button type="button" class="free-product-nav-btn next" id="freeProductNext">
                    <i class="fas fa-chevron-right"></i>
                </button>
            </div>
        </div>
