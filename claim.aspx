        ...
        <div>
            ...
            <div class="max-w-6xl mx-auto p-6">
                <div class="bg-white rounded-lg shadow-md p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <!-- Payment Section -->
                    <div class="mt-8">
                        <h2 class="text-xl font-semibold mb-6 border-b pb-2">Payment</h2>

                        <div class="border border-dashed rounded-lg p-6 text-center bg-gray-50">
                            <p class="text-gray-600 mb-2">🔒 Secure Payment</p>

                            <div class="text-lg font-semibold mb-6">
                                Total: <span class="text-green-600">699.00</span>
                            </div>
